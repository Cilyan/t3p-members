                    ...
                    <form method="POST" action="{{ $edit ? route('edition.update', ['edition' => $edition]) : route('edition.store') }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="trail_date" type="date" class="form-control{{ $errors->has('trail_date') ? ' is-invalid' : '' }}" name="trail_date" value="{{ old('trail_date', $edition->trail_date ? $edition->trail_date->toDateString() : null) }}" required>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input id="helper_subscriptions_open" type="date" class="form-control{{ $errors->has('helper_subscriptions_open') ? ' is-invalid' : '' }}" name="helper_subscriptions_open" value="{{ old('helper_subscriptions_open', $edition->helper_subscriptions_open ? $edition->helper_subscriptions_open->toDateString() : null) }}">
